            ...
            <aside class="right-side">
                ...
                <section class="content">             
                     <div class="row">   
                       ...
                       <form method="post" enctype="multipart/form-data"   action="user_save.php" 
									...
									<div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
											  ...
											  <label class="form-control">
												<input type="checkbox" name="SERVICE" id="SERVICE" value="1" > : SERVICE
											  </label>
											  <label class="form-control">
												<input type="checkbox" name="REPORT" id="REPORT" value="1" > : REPORT
											  </label>
										</div><!-- /.input group -->
                                    </div><!-- /.form group -->
