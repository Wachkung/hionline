...
<body>
  ...
  <!--MENU  HEAD-->
       ...
       <div id="page-wrapper">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">อัตราอัตรา การได้รับ aspirin ภายใน 24 ชั่วโมงของผู้ป่วยที่มีPrinciple Diagnosisเป็นAMIและไม่มีข้อห้ามของการให้ยานี้</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
          ...
          <input id="getDateButton" type="button" value="ค้นหาข้อมูล"/>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h3>อัตราอัตรา การได้รับ aspirin ภายใน 24 ชั่วโมงของผู้ป่วยที่มีPrinciple Diagnosisเป็นAMIและไม่มีข้อห้ามของการให้ยานี้</h3> 
                            <h3> </h3>
                            <p> </p>
                              <div class="row show-grid">
                          <div id="kpi_ami_aspirin"></div> 
    ...
    <script src="plugins/kpi_stroke_stat.js"></script>
