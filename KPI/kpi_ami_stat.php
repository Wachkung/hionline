...
<body>
  ...
  <!--MENU  HEAD-->
       ...
       <div id="page-wrapper">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">ผู้ป่วยAMIที่ได้รับ thrombolytic agents ภายใน 30 นาที เมื่อมาถึงร.พ.</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
          ...
          <input id="getDateButton" type="button" value="ค้นหาข้อมูล"/>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h3>ผู้ป่วยAMIที่ได้รับ thrombolytic agents ภายใน 30 นาที เมื่อมาถึงร.พ.</h3> 
                            <h3> </h3>
                            <p> </p>
                              <div class="row show-grid">
                          <div id="kpi_ami_stat"></div> 
    ...
    <script src="plugins/kpi_ami_stat.js"></script>
