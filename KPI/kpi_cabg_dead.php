...
<body>
  ...
  <!--MENU  HEAD-->
       ...
       <div id="page-wrapper">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">อัตราการเสียชีวิตของผู้ป่วยที่ทำ CABG  ค้นหาตามวันที่</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
          ...
          <input id="getDateButton" type="button" value="ค้นหาข้อมูล"/>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h3>อัตราการเสียชีวิตของผู้ป่วยที่ทำ CABG ค้นหาตามวันที่</h3> 
                            <h3> </h3>
                            <p> </p>
    ...
    <script src="plugins/kpi_cabg_dead.js"></script>
