...
<body>
  ...
  <!--MENU  HEAD-->
       ...
       <div id="page-wrapper">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">KPIที่1.4 อัตราการเสียชีวิตของผู้ป่วยระหว่างและหลังผ่าตัด(peri-operative mortality rate)</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
          ...
          <input id="getDateButton" type="button" value="ค้นหาข้อมูล"/>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h3>อัตราการเสียชีวิตของผู้ป่วยระหว่างและหลังผ่าตัด</h3> 
                            <h3> </h3>
                            <p> </p>
                              <div class="row show-grid">
                          <div id="major_or_dead"></div> 
    ...
    <script src="plugins/kpi_major_or_dead.js"></script>
