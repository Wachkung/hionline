...
<body>
  ...
  <!--MENU  HEAD-->
       ...
       <div id="page-wrapper">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">อัตราผู้ป่วย Ischemic strokeที่ได้รับ thrombolytic agent ภายใน60นาทีหลังมาถึง รพ</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
          ...
          <input id="getDateButton" type="button" value="ค้นหาข้อมูล"/>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h3>อัตราผู้ป่วย Ischemic strokeที่ได้รับ thrombolytic agent ภายใน60นาทีหลังมาถึง รพ</h3> 
                            <h3> </h3>
                            <p> </p>
                              <div class="row show-grid">
                          <div id="kpi_stroke_stat"></div> 
