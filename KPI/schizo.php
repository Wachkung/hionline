...
<body>
  ...
  <!--MENU  HEAD-->
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานสุขภาพจิต ค้นหาตามวันที่</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
          ...
          <input id="getDateButton" type="button" value="ค้นหาข้อมูล"/>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h3>ส่วนที่ 1 รายงานสุขภาพจิตรายงานสุขภาพจิต (ครั้ง)  </h3> 
                            <h3> </h3>
                            <p> </p>
              ...
              <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h3>ส่วนที่ 1 รายงานสุขภาพจิตรายงานสุขภาพจิต (คน)   </h3> 
                            <h3> </h3>
                            <p> </p>
                              <div class="row show-grid">
                          <div id="schizo2"></div> 
    ...
    <script src="plugins/schizo1.js"></script>
      
       <script src="plugins/schizo2.js"></script>
