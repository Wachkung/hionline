...
<body>
  ...
  <!--MENU  HEAD-->
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12 ">
                    <h1 class="page-header alert btn-success active ">โรค ผู้ป่วยโรคปอดอุดกั้นเรื้อรัง</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h3>ส่วนที่ 1 โรค ผู้ป่วยโรคปอดอุดกั้นเรื้อรัง  3 ปีย้อนหลัง </h3> 
                            <h3> </h3>
                            <p> </p>
    ...
    <script src="plugins/copdkpi.js"></script>
