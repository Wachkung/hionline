...
$query="select   
  'ipd',
SUM(CASE WHEN a.rgtdate BETWEEN '2010-10-01' and '2011-09-30'    THEN  a.daycount   end ) as aaa1 ,
 SUM(CASE WHEN a.rgtdate BETWEEN '2010-10-01' and '2011-09-30'    THEN  a.daycount*100/43800   end ) as xxx1 ,
  SUM(CASE WHEN a.rgtdate BETWEEN '2011-10-01' and '2012-09-30'    THEN  a.daycount   end ) as bbb1 , 
SUM(CASE WHEN a.rgtdate BETWEEN '2011-10-01' and '2012-09-30'    THEN  a.daycount*100/43800   end ) as xxx2 ,
 SUM(CASE WHEN a.rgtdate BETWEEN '2012-10-01' and '2013-09-30'    THEN  a.daycount   end ) as ccc1 ,
 SUM(CASE WHEN a.rgtdate BETWEEN '2012-10-01' and '2013-09-30'    THEN  a.daycount*100/43800  end ) as xxx3 ,
SUM(CASE WHEN a.rgtdate BETWEEN '2013-10-01' and '2014-09-30'    THEN  a.daycount   end ) as ddd4 ,
SUM(CASE WHEN a.rgtdate BETWEEN '2013-10-01' and '2014-09-30'    THEN  a.daycount*100/73000  end ) as xxx4  
from(SELECT 
year(ipt.dchdate) as dchdate ,
ipt.an,if(ipt.dchdate='0000-00-00',
DATEDIFF(DATE(NOW()),

date(ipt.rgtdate)),DATEDIFF(date(ipt.dchdate),date(ipt.rgtdate))) AS daycount,ipt.rgtdate
FROM hi.ipt WHERE ipt.rgtdate BETWEEN '2010-10-01' and '2014-09-30') as a     
";
