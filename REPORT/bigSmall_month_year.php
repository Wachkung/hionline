...
<body>
  ...
  <!--MENU  HEAD-->
      ...
      <?php include_once ('menu.php'); ?>     
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานผ่าตัดแยกประเภทเล็กใหญ่</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <label class="control-label col-sm-2 ">เลือกประเภท</label>
     <label class="control-label col-sm-3">   
   <select name="type_by" id="type_by" class="form-control input-sm" style="width:auto;">
   <option value="1">ผ่าตัดเล็ก-ใหญ่ ในเวลา</option>  
   <option value="2">ผ่าตัดเล็ก-ใหญ่ นอกเวลา</option>  
   </select>
   ...
   <option value="<?php echo date('Y')-6; ?>"><?php echo (date('Y')-6)+543; ?></option>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h4>รายงานผ่าตัดแยกประเภทเล็กใหญ่</h4> 
                            <h3> </h3>
                            <p> </p>
    ...
    <script src="../js/sb-admin-2.js"></script>
	 ...
	 <script src="plugins/bigSmall_month_year.js"></script>
