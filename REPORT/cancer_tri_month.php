  ...
  <!--MENU  HEAD-->
      ...
      <?php include_once ('menu.php'); ?>     
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานมะเร็งรายใหม่</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
   ...
   <option value="<?php echo date('Y')-6; ?>"><?php echo (date('Y')-6)+543; ?></option>
                    ...
                    <label class="control-label col-sm-2 ">เลือกไตรมาส</label>
            <label class="control-label col-sm-3">                 
           <select name="date_by" id="date_by" class="form-control input-sm" style="width:auto;">
         <option value="0">เลือกไตรมาส</option>
         <option value="-10-01.-12-31">ไตรมาสที่1 (ตค-ธค)</option>
        <option value="-01-01.-03-31">ไตรมาสที่2 (มค-มีค)</option>
         <option value="-04-01.-06-30">ไตรมาสที่3 (เมย-มิย)</option>
           <option value="-07-01.-09-30">ไตรมาสที่4 (กค-กย)</option>
          </select>
    ...
    <script src="../js/sb-admin-2.js"></script>
	 ...
	 <script src="plugins/cancer_tri_month.js"></script>
