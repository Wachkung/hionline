...
<div id="content">
    <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
        <li class="active"><a href="#one" data-toggle="tab">รายง่านวันนี้</a></li>
        <li><a href="#two" data-toggle="tab">รายง่านเดือนนี้</a></li>
        <li><a href="#three" data-toggle="tab">รายง่านปี</a></li>
        <li><a href="#four" data-toggle="tab">รายงานอื่นๆ</a></li>
        <li><a href="#five" data-toggle="tab">รายงานอื่นๆ</a></li>
    </ul>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h4>รายงานผู้มารับบริการงานผู้ป่วยนอกวันนี้รวมทั้งสิน</h4> 
                            <h3> </h3>
