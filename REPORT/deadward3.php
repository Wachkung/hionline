...
select a.idpm,a.nameidpm,
    
    
SUM(CASE WHEN a.yeaript between '$year5'and '$year5_1' THEN a.can END) AS 'aaa' ,
SUM(CASE WHEN a.yeaript between '$year4'and '$year4_1' THEN a.can END) AS 'bbb' ,
 SUM(CASE WHEN a.yeaript between '$year3'and '$year3_1' THEN a.can END) AS 'ccc' ,
SUM(CASE WHEN a.yeaript between '$year2'and '$year2_1' THEN a.can END) AS 'ddd' 
...
WHERE ipt.dchtype in(8,9) and  year(ipt.dchdate)  BETWEEN '$y4'  and  '$Y'  GROUP BY an  ) as  a   GROUP BY  a.idpm   ORDER BY can ,ddd desc
";
