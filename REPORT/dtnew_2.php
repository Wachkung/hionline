...
$query1=" 
 select  b.id,b.namegrdt,
    ...
    count(case when b.age between '1'  and '2' then b.can    end  ) as 'aaa5',
    count(case when b.age between '3'  and '5' then b.can    end  ) as 'bbb5',
   count(case when b.age between '6'  and '14' then b.can    end  ) as 'ccc5',
   count(b.can) as ccan
 from(
select
a.age,
...
where grdtdtxname.id in(1,3,5,6)
		...
		$data[] = array(
			'namegrdt'=>  iconv('TIS-620','UTF-8//IGNORE',$row['namegrdt']) ,
			      'aaa5' => $row['aaa5'] ,
                    ...
                    'ccc5'=>  iconv('TIS-620','UTF-8//IGNORE',$row['ccc5']) ,
		    'ccan'=>  iconv('TIS-620','UTF-8//IGNORE',$row['ccan']) ,
