...
$query1=" 
   select  b.id,b.namegrdt,
        
   count(case when b.age between '1'  and '2' then b.can    end  ) as 'aaas',
   sum(case when b.age between '1'  and '2' then b.can    end  ) as 'aaas1',
count(case when b.age between '3'  and '5' then b.can    end  ) as 'bbbs',
sum(case when b.age between '3'  and '5' then b.can    end  ) as 'bbbs1',

count(case when b.age between '6'  and '14' then b.can    end  ) as 'cccs',
sum(case when b.age between '6'  and '14' then b.can    end  ) as 'cccs1'
