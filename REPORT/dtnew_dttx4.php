...
$query1=" 
select  b.id,b.namegrdt  as  namegrdt4,
        
   count(  b.can  ) as countdttx4,
   sum(b.can   ) as sumdttx4
...
where grdtdtxname.id in(17,18,21,22)
GROUP BY a.hn

   order by age,vn asc) as b   GROUP BY b.id,namegrdt4
 ";
...
GROUP BY prediag  ORDER BY prediagc5opd desc LIMIT 10) as a    INNER JOIN icd101 on icd101.icd10 = a.prediag";
	...
	*/
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$data[] = array(
			'namegrdt4'=>  iconv('TIS-620','UTF-8//IGNORE',$row['namegrdt4']) ,
			      'countdttx4' => $row['countdttx4'] ,
                     'sumdttx4' => $row['sumdttx4'] ,
