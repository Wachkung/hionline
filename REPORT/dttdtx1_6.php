...
$query="  select a.grdt,a.namegrdt,
    ...
    count(CASE WHEN a.yeaript between '2011-10-01'and '2012-09-30'  and a.codedtt_gr= '01'  THEN a.hn END) AS 'aaa' ,
    SUM(CASE WHEN a.yeaript between '2011-10-01'and '2012-09-30'  and a.codedtt_gr= '01'  THEN a.can END) AS 'aaa1' ,

 
count(CASE WHEN a.yeaript between '2012-10-01'and '2013-09-30' and a.codedtt_gr= '01'THEN a.hn END) AS 'aaa2' ,
 sum(CASE WHEN a.yeaript between '2012-10-01'and '2013-09-30' and a.codedtt_gr= '01'THEN a.can END) AS 'aaa3' ,
 
count(CASE WHEN a.yeaript between '2013-10-01'and '2014-09-30' and a.codedtt_gr= '01'THEN a.hn END) AS 'aaa4' ,
SUM(CASE WHEN a.yeaript between '2013-10-01'and '2014-09-30' and a.codedtt_gr= '01'THEN a.can END) AS 'aaa5' ,
 
    count(CASE WHEN a.yeaript between '2011-10-01'and '2012-09-30'  and a.codedtt_gr= '02'  THEN a.hn END) AS 'bbb' ,
    SUM(CASE WHEN a.yeaript between '2011-10-01'and '2012-09-30'  and a.codedtt_gr= '02'  THEN a.can END) AS 'bbb1' ,
    
      count(CASE WHEN a.yeaript between '2012-10-01'and '2013-09-30'  and a.codedtt_gr= '02'  THEN a.hn END) AS 'bbb2' ,
    SUM(CASE WHEN a.yeaript between '2012-10-01'and '2013-09-30' and a.codedtt_gr= '02' THEN a.can END) AS 'bbb3' ,
   
     count(CASE WHEN a.yeaript between '2013-10-01'and '2014-09-30'  and a.codedtt_gr= '02'  THEN a.hn END) AS 'bbb4' ,
     SUM(CASE WHEN a.yeaript between '2013-10-01'and '2014-09-30' and a.codedtt_gr= '02'THEN a.can END) AS 'bbb5' 
...
WHERE year(dt.vstdttm) between '2011' and '2014'
  and 
 grdtdtx.grdtx  between  1 and  6  and  dt.vn <> 0
