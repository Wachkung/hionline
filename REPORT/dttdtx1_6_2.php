...
$query="  select a.grdt,a.namegrdt,
     ...
     count(CASE WHEN a.yeaript between '2011-10-01'and '2012-09-30'  and a.codedtt_gr= '03'  THEN a.hn END) AS 'ccc' ,
    SUM(CASE WHEN a.yeaript between '2011-10-01'and '2012-09-30'  and a.codedtt_gr= '03'  THEN a.can END) AS 'ccc1' ,
    
 count(CASE WHEN a.yeaript between '2012-10-01'and '2013-09-30'  and a.codedtt_gr= '03'  THEN a.hn END) AS 'ccc2' ,
    SUM(CASE WHEN a.yeaript between '2012-10-01'and '2013-09-30' and a.codedtt_gr= '03' THEN a.can END) AS 'ccc3' ,
   
 count(CASE WHEN a.yeaript between '2013-10-01'and '2014-09-30'  and a.codedtt_gr= '03'  THEN a.hn END) AS 'ccc4' ,
   SUM(CASE WHEN a.yeaript between '2013-10-01'and '2014-09-30' and a.codedtt_gr= '03'THEN a.can END) AS 'ccc5' ,
 
   



 count(CASE WHEN a.yeaript between '2011-10-01'and '2012-09-30'  and a.codedtt_gr= '04'  THEN a.hn END) AS 'ddd' ,

SUM(CASE WHEN a.yeaript between '2011-10-01'and '2012-09-30'  and a.codedtt_gr= '04'  THEN a.can END) AS 'ddd1' ,
 

 count(CASE WHEN a.yeaript between '2012-10-01'and '2013-09-30'  and a.codedtt_gr= '04'  THEN a.hn END) AS 'ddd2' ,

  SUM(CASE WHEN a.yeaript between '2012-10-01'and '2013-09-30' and a.codedtt_gr= '04' THEN a.can END) AS 'ddd3' ,
   
 count(CASE WHEN a.yeaript between '2013-10-01'and '2014-09-30'  and a.codedtt_gr= '04'  THEN a.hn END) AS 'ddd4' ,

SUM(CASE WHEN a.yeaript between '2013-10-01'and '2014-09-30' and a.codedtt_gr= '04'THEN a.can END) AS 'ddd5' 
