...
<body>
  ...
  <!--MENU  HEAD-->
        <script type="text/javascript">
            $(document).ready(function () {
                $("#jqxMenu").jqxMenu({ width: '100%', height: '40px' });
            });
 ...
 <div id='jqxWidget'>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h3>การกลับมารักษาซ้ำ (Re-admit) </h3>
                            <p>อธิาย.</p>
                               สูตรในการคำนวณ  :           
   =  จำนวนผู้ป่วยที่กลับมารักษาซ้ำด้วยโรคเดิมภายใน  28 วันภายหลังการจำหน่ายโดยไม่ได้วางแผน  x 100
                                    จำนวนผู้ป่วยที่จำหน่ายทั้งหมดในเดือนก่อนหน้า	
                              <h3>การกลับมารักษาซ้ำ (Re-admit) </h3>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h3 id="grid-responsive-resets">KPI</h3>
                            <p> อธิบาย</p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h3 id="grid-column-ordering">KPI</h3>
                            <p> อธิบาย</p>
  ...
  <script src="plugins/kpi.js"></script>
</body>
