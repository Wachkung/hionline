...
$query=" 
 ...
 'total bed',
  ...
  SUM(CASE WHEN a.dchdate BETWEEN '2011-10-01' and '2012-09-30'    THEN  a.daycnt   end ) as aaa , 
 
 SUM(CASE WHEN a.dchdate BETWEEN '2012-10-01' and '2013-09-30'    THEN  a.daycnt   end ) as bbb,
 
SUM(CASE WHEN a.dchdate BETWEEN '2013-10-01' and '2014-09-30'    THEN  a.daycnt   end ) as ccc ,
 SUM(CASE WHEN a.dchdate BETWEEN '2014-10-01' and '2015-09-30'    THEN   a.daycnt   end ) as ddd 
...
select 
 ...
 'จำนวนผู้ป่วยใน',
  ...
  SUM(CASE WHEN a.dchdate BETWEEN '2011-10-01' and '2012-09-30'    THEN  a.an   end ) as aaa , 
 
 SUM(CASE WHEN a.dchdate BETWEEN '2012-10-01' and '2013-09-30'    THEN  a.an   end ) as   bbb,
 
SUM(CASE WHEN a.dchdate BETWEEN '2013-10-01' and '2014-09-30'    THEN  a.an   end ) as ccc , 
 SUM(CASE WHEN a.dchdate BETWEEN '2014-10-01' and '2015-09-30'    THEN   a.an   end ) as ddd
...
SUM(CASE WHEN a.dchdate BETWEEN '2011-10-01' and '2012-09-30'    THEN  (a.daycnt*100)/43800   end ) as aaa ,
 
 SUM(CASE WHEN a.dchdate BETWEEN '2012-10-01' and '2013-09-30'    THEN  (a.daycnt*100)/43800  end ) as bbb,
 
SUM(CASE WHEN a.dchdate BETWEEN '2013-10-01' and '2014-09-30'    THEN  (a.daycnt*100)/73000  end ) as  ccc, 
 SUM(CASE WHEN a.dchdate BETWEEN '2014-10-01' and '2015-09-30'    THEN  (a.daycnt*100)/73000   end ) as ddd
...
from (select   
, 
  SUM(CASE WHEN b.dchdate BETWEEN '2011-10-01' and '2012-09-30'    THEN  b.daycnt   end ) as aaaa , 
   SUM(CASE WHEN b.dchdate BETWEEN '2011-10-01' and '2012-09-30'    THEN  b.can    end ) as aaa1 , 
  SUM(CASE WHEN b.dchdate BETWEEN '2011-10-01' and '2012-09-30'    THEN  b.daycnt   end ) as bbbb , 
 SUM(CASE WHEN b.dchdate BETWEEN '2012-10-01' and '2013-09-30'    THEN  b.can   end ) as bbb1, 
SUM(CASE WHEN b.dchdate BETWEEN '2013-10-01' and '2014-09-30'    THEN  b.daycnt   end ) as cccc  ,
 SUM(CASE WHEN b.dchdate BETWEEN '2013-10-01' and '2014-09-30'    THEN b.can    end ) as  ccc1  ,
   SUM(CASE WHEN b.dchdate BETWEEN '2014-10-01' and '2015-09-30'    THEN  b.daycnt   end ) as dddd ,
  SUM(CASE WHEN b.dchdate BETWEEN '2014-10-01' and '2015-09-30'    THEN  b.can   end ) as ddd1
from(
...
(select 
 ...
 count(CASE WHEN a.yeaript between '2011-10-01'and '2012-09-30' and  a.dchtype in(8,9)   THEN  a.an  END) AS 'aaaa' ,
 sum(CASE WHEN a.yeaript between '2011-10-01'and '2012-09-30'   THEN  a.canqq  END) AS 'xxx'  ,

count(CASE WHEN a.yeaript between '2012-10-01'and '2013-09-30'  and  a.dchtype in(8,9)   THEN  a.an  END) AS 'aaaa2' ,
 sum(CASE WHEN a.yeaript between '2012-10-01'and '2013-09-30'   THEN  a.canqq  END) AS 'xxx2'  ,

 count(CASE WHEN a.yeaript between '2013-10-01'and '2014-09-30'  and  a.dchtype in(8,9)   THEN  a.an  END) AS 'aaaa3' ,
  sum(CASE WHEN a.yeaript between '2013-10-01'and '2014-09-30'    THEN  a.canqq  END) AS 'xxx3' ,  
count(CASE WHEN a.yeaript between '2014-10-01'and '2015-09-30' and  a.dchtype in(8,9)   THEN  a.an  END) AS 'aaaa4' ,
 sum(CASE WHEN a.yeaript between '2014-10-01'and '2015-09-30'    THEN  a.canqq  END) AS 'xxx4'  
 from(
...
SUM(CASE WHEN date(a.vstdttm) BETWEEN '2012-10-01' and '2013-09-30'   and a.ovstost  = '4'    THEN  a.cvn   end ) as cc1 bbbbb1,
...
SUM(CASE WHEN date(a.vstdttm) BETWEEN '2014-10-01' and '2015-09-30'   and a.ovstost <> '4' and a.an = 0  THEN  a.cvn   end ) as ddddd  ,
 
SUM(CASE WHEN date(a.vstdttm) BETWEEN '2014-10-01' and '2015-09-30'   and a.ovstost  = '4'    THEN  a.cvn   end ) as ddddd1  
  from(select 
...
SUM(CASE WHEN d.yeaript between '2013-10-01'and '2014-09-30' THEN (d.can*100)/49042 END) AS 'ccc' ,
 ...
 SUM(CASE WHEN d.yeaript between '2014-10-01'and '2015-09-30' THEN (d.can*100)/49042 END) AS 'ddd' 
