...
from(select  
SUM(CASE WHEN date(a.vstdttm) BETWEEN '2010-10-01' and '2011-09-30'   and a.ovstost <> '4' and a.an = 0  THEN  a.cvn   end ) as aaaaa  ,
 
SUM(CASE WHEN date(a.vstdttm) BETWEEN '2010-10-01' and '2011-09-30'   and a.ovstost  = '4'    THEN  a.cvn   end ) as aaaaa1  ,


SUM(CASE WHEN date(a.vstdttm) BETWEEN '2011-10-01' and '2012-09-30'   and a.ovstost <> '4' and a.an = 0  THEN  a.cvn   end ) as bbbbb  ,
SUM(CASE WHEN date(a.vstdttm) BETWEEN '2011-10-01' and '2012-09-30'   and a.ovstost  = '4'    THEN  a.cvn   end ) as bbbbb1 ,


SUM(CASE WHEN date(a.vstdttm) BETWEEN '2012-10-01' and '2013-09-30'   and a.ovstost <> '4' and a.an = 0  THEN  a.cvn   end ) as ccccc  ,
SUM(CASE WHEN date(a.vstdttm) BETWEEN '2012-10-01' and '2013-09-30'   and a.ovstost  = '4'    THEN  a.cvn   end ) as ccccc1 ,

SUM(CASE WHEN date(a.vstdttm) BETWEEN '2013-10-01' and '2014-09-30'   and a.ovstost <> '4' and a.an = 0  THEN  a.cvn   end ) as ddddd  ,
SUM(CASE WHEN date(a.vstdttm) BETWEEN '2013-10-01' and '2014-09-30'   and a.ovstost  = '4'    THEN  a.cvn   end ) as ddddd1 
 ...
 where   year(ovst.vstdttm) BETWEEN '2010' and  '20124'   group by vn) as  a) as b

union


select 'readmitted',
SUM(CASE WHEN d.yeaript between '2010-10-01'and '2011-09-30' THEN (d.can*100)/37230 END) AS 'aaa' ,

SUM(CASE WHEN d.yeaript between '2011-10-01'and '2012-09-30' THEN (d.can*100)/40111 END) AS 'bbb' ,
 SUM(CASE WHEN d.yeaript between '2012-10-01'and '2013-09-30' THEN (d.can*100)/39749 END) AS 'ccc' ,
SUM(CASE WHEN d.yeaript between '2013-10-01'and '2014-09-30' THEN (d.can*100)/49042 END) AS 'ddd' 
...
where  a.ahn  > 1   and  year(ipt.dchdate)  between '2010'  and  '2014' 
