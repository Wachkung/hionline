...
AND NOT (ovstdx.icd10 like 'V%' OR ovstdx.icd10  LIKE 'W%'OR ovstdx.icd10  LIKE 'X%'OR ovstdx.icd10  LIKE 'Y%')
	 and ovstdx.icd10 not in( 'Z370','Z232','Z246','Z380','Z348'
...
ipt
WHERE
DATE_FORMAT(ipt.dchdate,'%Y-%m-%d') BETWEEN '$startDate' AND '$endDate' AND NOT (ipt.prediag like 'V%' OR ipt.prediag  LIKE 'W%'OR ipt.prediag  LIKE 'X%'OR ipt.prediag  LIKE 'Y%')
	 and ipt.prediag not in( 'Z370','Z232','Z246','Z380','Z348'
,'Z480','Z133','Z00','Z242','U77')
