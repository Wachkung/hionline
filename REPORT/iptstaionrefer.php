...
SUM(CASE WHEN a.dchdate between '2011-10-01'and '2012-09-30' THEN a.can END) AS 'aaa' ,
SUM(CASE WHEN a.dchdate between '2012-10-01'and '2013-09-30' THEN a.can END) AS 'bbb' ,
 SUM(CASE WHEN a.dchdate between '2013-10-01'and '2014-09-30' THEN a.can END) AS 'ccc' ,
SUM(CASE WHEN a.dchdate between '2014-10-01'and '2015-09-30' THEN a.can END) AS 'ddd' 
