...
<body>
  ...
  <!-- Navigation -->
        ...
        <!-- Page Content -->
            ...
            <div class="row">
                <div class="col-lg-12">
               <p style=" width:100%;";><center><div style=" width:10%; font-size:14px; padding-left:5px; float: left;  border:#f00 0px solid;"> </div><div id="showTime" style=" width:90%; font-size:25px; padding-left:25px; float: left;  border:#f00 0px solid;"></div></center></p>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
   ...
   <script src="plugins/job_moniter.js"></script>
