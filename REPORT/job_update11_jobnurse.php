...
WHERE   ipt.rgtdate=CURDATE() and
  ipt.dchtype in('0') and ipt.ward!=''  and ipt.rgttime BETWEEN '725' and '1525'
...
WHERE   ipt.dchdate =CURDATE() and
  ipt.dchtype in('1','2') and ipt.ward!=''  and ipt.dchtime BETWEEN '725' and '1525'
...
WHERE   ipt.dchdate =CURDATE() and
  ipt.dchtype ='4' and ipt.ward!=''  and ipt.dchtime BETWEEN '725' and '1525'
...
WHERE   ipt.dchdate =CURDATE() and
  ipt.dchtype in('8','9') and ipt.ward!=''  and ipt.dchtime BETWEEN '725' and '1525'
...
WHERE   ipt.dchdate =CURDATE() and
  ipt.dchtype in('3') and ipt.ward!=''  and ipt.dchtime BETWEEN '725' and '1525'
...
and iptmove.timein BETWEEN '725' and '1525'
...
and iptmove.srvtime BETWEEN '725' and '1525'
...
'2'
   ...
   job_nurse.job_total, 
	...
	job_nurse.job_date
FROM job_nurse  
where job_nurse.job_date = CURDATE()  and job_nurse.type_job ='1') as a                 
