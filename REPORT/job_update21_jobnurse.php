...
WHERE   ipt.rgtdate=CURDATE() and
  ipt.dchtype in('0') and ipt.ward!=''  and ipt.rgttime BETWEEN '1526' and '2355'
...
WHERE   ipt.dchdate =CURDATE() and
  ipt.dchtype in('1','2') and ipt.ward!=''  and ipt.dchtime BETWEEN '1526' and '2355'
...
WHERE   ipt.dchdate =CURDATE() and
  ipt.dchtype ='4' and ipt.ward!=''  and ipt.dchtime BETWEEN '1526' and '2355'
...
WHERE   ipt.dchdate =CURDATE() and
  ipt.dchtype in('8','9') and ipt.ward!=''  and ipt.dchtime BETWEEN '1526' and '2355'
...
WHERE   ipt.dchdate =CURDATE() and
  ipt.dchtype in('3') and ipt.ward!=''  and ipt.dchtime BETWEEN '1526' and '2355'
...
and iptmove.timein BETWEEN '1526' and '2355'
...
and iptmove.srvtime BETWEEN '1526' and '2355'
...
'3'
	...
	job_nurse.job_total+(((((job_nurse.job_add-job_dischg)-job_nurse.job_refer)-job_nurse.job_escape)-job_nurse.job_dead_au)-job_nurse.job_move_out) as job_evening,
   job_nurse.job_total, 
	job_nurse.idpm, 
	job_nurse.nameidpm, 
	job_nurse.job_add, 
	...
	job_nurse.job_date
FROM job_nurse  
where job_nurse.job_date = CURDATE()  and job_nurse.type_job ='2') as a                 
