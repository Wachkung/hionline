  ...
  <!--MENU  HEAD-->
      ...
      <?php include_once ('menu.php'); ?>     
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานกลุ่มโรค IPD (DM&HT) คน/จำนวนวันนอน</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
   ...
   <option value="<?php echo date('Y')-6; ?>"><?php echo (date('Y')-6)+543; ?></option>
         ...
         <option value="1">E10-E14</option>
        <option value="2">I10-115, 167.4,H35.0</option>
         <option value="3">I21.0-I21.3</option>
           <option value="4">I20-I25</option>
           <option value="5">J440-J449</option>
           <option value="6">N181-N184</option>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h4>รายงาน IPD กลุ่มโรค(DM-HT)คน/วันนอน</h4> 
                            <h3> </h3>
                            <p> </p>
    ...
    <script src="../js/sb-admin-2.js"></script>
	 ...
	 <script src="plugins/old_dmht_ipd_year.js"></script>
