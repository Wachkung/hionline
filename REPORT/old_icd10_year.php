  ...
  <!--MENU  HEAD-->
      ...
      <?php include_once ('menu.php'); ?>     
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานอันดับโรคผู้สูงอายุ คน/ครั้ง</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
   ...
   <option value="<?php echo date('Y')-6; ?>"><?php echo (date('Y')-6)+543; ?></option>
                          ...
                          <label class="control-label col-sm-2 ">จำนวนอันดับ</label>
                    <label class="control-label col-sm-2"> 
                    <div id='jqxWidget'></div>
           ...
           <option value="30">30</option>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h3>รายงานอันดับโรคผู้สูงอายุ คน/ครั้ง</h3> 
                            <h3> </h3>
                            <p> </p>
    ...
    <script src="../js/sb-admin-2.js"></script>
	 ...
	 <script src="plugins/old_icd10_year.js"></script>
