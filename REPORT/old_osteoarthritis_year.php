  ...
  <!--MENU  HEAD-->
      ...
      <?php include_once ('menu.php'); ?>     
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงาน Osteoarthritis & Incontinence</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
   ...
   <option value="<?php echo date('Y')-6; ?>"><?php echo (date('Y')-6)+543; ?></option>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h4>รายงาน Osteoarthritis & Incontinence </h4> 
                            <h3> </h3>
                            <p> </p>
    ...
    <script src="../js/sb-admin-2.js"></script>
	 ...
	 <script src="plugins/old_osteoarthritis_year.js"></script>
