...
select count(hn) as cns,
xx.icd10,xx.icd10name
 from (
SELECT ovst.hn, icd101.icd10name, icd101.icd10
FROM ovst
INNER JOIN ovstdx ON ovst.vn = ovstdx.vn
INNER JOIN icd101 ON ovstdx.icd10 = icd101.icd10
WHERE ovst.ovstost ='2' and   date(ovst.vstdttm) between '$year2'  and  '$year2_1' group by ovst.hn ) as xx  group by xx.icd10 order by cns desc 
limit 20
...
WHERE ovst.ovstost ='2' and   date(ovst.vstdttm) between '2015-10-01'  and  '2016-09-30'
GROUP BY     icd101.icd10  ORDER BY cns DESC  LIMIT 20
