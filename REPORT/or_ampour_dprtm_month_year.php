  ...
  <!--MENU  HEAD-->
      ...
      <?php include_once ('menu.php'); ?>     
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานผู้มารับบริการผ่าตัดแยกรายอำเภอรายเดือน/ปีแยกตามคลีนิค</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="form-group">
             ...
             <label class="control-label col-sm-1 ">เลือกประเภท</label>
                    <label class="control-label col-sm-3"> 
                    <div id='jqxWidget'></div>
           <select name="search_by" id="search_by" class="form-control input-sm">
          <option value="1">ผู้มารับบริการผ่าตัดแยกรายอำเภอรายเดือน/ปี (ครั้ง)</option>
        <option value="2">ผู้มารับบริการผ่าตัดแยกรายอำเภอรายเดือน/ปี (คน)</option>
                 </select>

                    </label>
             <label class="control-label col-sm-1 ">เลือกปี</label>
   ...
   <option value="<?php echo date('Y')-6; ?>"><?php echo (date('Y')-6)+543; ?></option>
                    ...
                    <label class="control-label col-sm-1 ">เลือกคลีนิค</label>
            <label class="control-label col-sm-3">   
...
?>
        ...
        <?php } ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h4>รายงานผู้มารับบริการผ่าตัดแยกรายอำเภอรายเดือน/ปีแยกตามคลีนิค</h4> 
                            <h3> </h3>
                            <p> </p>
    ...
    <script src="../js/sb-admin-2.js"></script>
	 ...
	 <script src="plugins/or_ampour_dprtm_month_year.js"></script>
