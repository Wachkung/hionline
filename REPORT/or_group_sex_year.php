  ...
  <!--MENU  HEAD-->
      ...
      <?php include_once ('menu.php'); ?>     
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานผู้มารับบริการผ่าตัดตามกลุ่มเพศ5 ปีย้อนหลัง</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
          ...
          <option value="<?php echo date('Y'); ?>"><?php echo date('Y')+543; ?></option>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h4>รายงานผู้มารับบริการผ่าตัดตามกลุ่มเพศ5 ปีย้อนหลัง</h4> 
                            <h3> </h3>
                            <p> </p>
    ...
    <script src="../js/sb-admin-2.js"></script>
	  ...
	  <script src="plugins/or_group_sex_year.js"></script>
