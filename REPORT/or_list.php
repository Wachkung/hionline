...
.bigfont4 {font-size: 30px; font-weight: bold; color:#009900; font-family: 'THSarabunNew';}
.bigfont5 {font-size: 30px; font-weight: bold; color:#CC6600;   font-family: 'THSarabunNew';}
...
font-size: 25px; font-weight:bold !important;
  ...
  <!-- Navigation -->
       ...
       <div id="site-wrapper">
            <div class="row">
               ...
               <p style=" width:100%;";><center><div id="showTime" style="font-size:25px; padding-left:25px; "></center></div></p>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default" >
                         <div  style=" width:50%; border:#f00 0px solid; float: left; font-size:30px; background-color:#FFA500; color:#FFFFFF; "><center>รอการผ่าตัด</center></div>   
                         <div  style="width:50%; border:#f00 0px solid;float: left; font-size:30px; background-color:#008000; color:#FFFFFF; "><center>ผ่าตัดเสร็จสิ้น</center></div>      
   ...
   <script src="plugins/or_list.js"></script>
   <script src="plugins/or_list2.js"></script>
