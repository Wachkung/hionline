  ...
  <!--MENU  HEAD-->
      ...
      <?php include_once ('menu.php'); ?>     
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานผ่าตัดรายโรคแยกตามรายเดือน</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="form-group">
             ...
             <label class="control-label col-sm-2 btn bg-warning ">กรุณาเลือกปี</label>
                    <label class="control-label col-sm-3"> 
                    <div id='jqxWidget'></div>
           <select name="date_by" id="date_by">
         <option value="0">>>>>เลือกปีที่ต้องการ<<<<</option>
   ...
   <option value="<?php echo date('Y')-6; ?>"><?php echo (date('Y')-6)+543; ?></option>
            ...
            <input id="YearButton" type="button" value="ค้นหาข้อมูล"/>
        	</label>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h3>รายงานผ่าตัดแยกตามรายศัลยกรรม(ICD9cm)</h3> 
                            <h3> </h3>
                            <p> </p>
    ...
    <script src="../js/sb-admin-2.js"></script>
	 ...
	 <script src="plugins/ordig_month.js"></script>
