...
$(document).ready(function () {
           ...
           width: true,
			    ...
			    { text: 'ยกมา(บ)', dataField: 'job_total' },
            ...
            { text: '   รวม(บ)   ', dataField: 'job_end_m' }
			    ]
            });

 $("#excelExportjobey").click(function () {
                $("#showdivjobey").jqxGrid('exportdata', 'xls', 'jqxGrid');           
            });
