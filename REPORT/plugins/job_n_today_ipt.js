...
$(document).ready(function () {
           ...
           width: true,
			    ...
			    { text: 'ยกมา(ด)', dataField: 'job_total' },
 ...
 { text: 'ย้ายไป', dataField: 'job_move_out' },        
            ...
            { text: '   รวม(ด)   ', dataField: 'job_end_m' }
			    ]
            });

 $("#excelExportjobn").click(function () {
                $("#showdivjobn").jqxGrid('exportdata', 'xls', 'jqxGrid');           
            });
