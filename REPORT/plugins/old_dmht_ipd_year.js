...
{ name: 'visit_total', type: 'string' } 
                  ...
                  type: "POST",
				  url : "old_dmht_ipd_year_query.php",
            ...
            $("#showdiv").jqxGrid(
            {
			    ...
			    columns: [
					...
					{ text: 'คน', columnGroup: 'ตค', dataField: 'human_a', },
                     { text: 'วันนอน', columnGroup: 'ตค', dataField: 'visit_a', },	
			      { text: 'คน', columnGroup: 'พย', dataField: 'human_b', },
                     { text: 'วันนอน', columnGroup: 'พย', dataField: 'visit_b', },	
			        { text: 'คน', columnGroup: 'ธค', dataField: 'human_c', },
                     { text: 'วันนอน', columnGroup: 'ธค', dataField: 'visit_c', },	
			         { text: 'คน', columnGroup: 'มค', dataField: 'human_d', },
                     { text: 'วันนอน', columnGroup: 'มค', dataField: 'visit_d', },		
			     { text: 'คน', columnGroup: 'กพ', dataField: 'human_e', },
                     { text: 'วันนอน', columnGroup: 'กพ', dataField: 'visit_e', },	
			          { text: 'คน', columnGroup: 'มีค', dataField: 'human_f', },
                     { text: 'วันนอน', columnGroup: 'มีค', dataField: 'visit_f', },	
			        { text: 'คน', columnGroup: 'เมษ', dataField: 'human_g', },
                     { text: 'วันนอน', columnGroup: 'เมษ', dataField: 'visit_g', },	
			         { text: 'คน', columnGroup: 'พค', dataField: 'human_h', },
                     { text: 'วันนอน', columnGroup: 'พค', dataField: 'visit_h', },		
			         { text: 'คน', columnGroup: 'มิย', dataField: 'human_i', },
                     { text: 'วันนอน', columnGroup: 'มิย', dataField: 'visit_i', },	
			        { text: 'คน', columnGroup: 'กค', dataField: 'human_j', },
                     { text: 'วันนอน', columnGroup: 'กค', dataField: 'visit_j', },	
			        { text: 'คน', columnGroup: 'สค', dataField: 'human_k', },
                     { text: 'วันนอน', columnGroup: 'สค', dataField: 'visit_k', },	
			          { text: 'คน', columnGroup: 'กย', dataField: 'human_l', },
                     { text: 'วันนอน', columnGroup: 'กย', dataField: 'visit_l', },	
			         { text: 'คน', columnGroup: 'รวม', dataField: 'human_total', },
                     { text: 'วันนอน', columnGroup: 'รวม', dataField: 'visit_total', },						    
  ...
  $("#excelExport").click(function () {
                $("#showdiv").jqxGrid('exportdata', 'xls', 'รายงาน_IPD_กล่มโรค_DMHT_คน-จำนวนวันนอน');           
            });
