...
{ name: 'total', type: 'string' } 
                  ...
                  type: "POST",
				  url : "or_ampour_dprtm_month_year_query.php",
				
                   
				  data:jQuery.parseJSON( '{ "year":"'+year+'","type_by":"'+type_by+'","search_by":"'+search_by+'"   }' ),
            ...
            $("#showdiv").jqxGrid(
            {
			    ...
			    columns: [
                    ...
                    { text: 'อำเภอ', dataField: 'c', }, 
                    { text: 'จังหวัด', dataField: 'd', }, 	
  ...
  $("#excelExport").click(function () {
                $("#showdiv").jqxGrid('exportdata', 'xls', 'รายงาน_OR_ผู้มารับบริการผ่าตัดแยกรายอำเภอรายเดือน/ปีแยกตามคลีนิค');           
            });
