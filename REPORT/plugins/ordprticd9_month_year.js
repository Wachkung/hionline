...
{ name: 'total', type: 'string' } 
                  ...
                  type: "POST",
				  url : "ordprticd9_month_year_query.php",
            ...
            $("#showdiv").jqxGrid(
            {
			    ...
			    columns: [
                    ...
                    { text: 'รหัสicd9cm', dataField: 'cname', }, 
                    { text: 'ความหมาย', dataField: 'nameicd9', }, 	
  ...
  $("#excelExport").click(function () {
                $("#showdiv").jqxGrid('exportdata', 'xls', 'รายงาน_OR_ผ่าตัดแยกตามรายศัลยกรรม(ICD9cm)');           
            });
