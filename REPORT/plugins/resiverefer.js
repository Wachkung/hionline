...
$(document).ready(function () {
            ...
            $("#resiverefer").jqxGrid(
            {
			    ...
			    columns: [
                      ...
                      { text: 'รหัสสถานบริการ', dataField: 'rfrlct'   },
					   
                    				   { text: 'ชื่อสถานบริการ', dataField: 'off_name1'   },	

			                                             { text: ''+year1+'', name: 'Case_Elective', dataField: 'aaa'   } ,
					    { text: ''+year2+'', dataField: 'bbb'   },			  
			                                            { text: ''+year3+'', dataField: 'ccc', width: 60 } ,
