...
{ name: 'total', type: 'string' } 
  ...
  $("#excelExportsendipd1").click(function () {
                $("#showdivsendipd1").jqxGrid('exportdata', 'xls', 'รายงาน_OR_ผ่าตัดแยกแผนกรายปี');           
            });
