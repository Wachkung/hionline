...
{ name: 'total', type: 'string' } 
  ...
  $("#excelExportsendipd2").click(function () {
                $("#showdivsendipd2").jqxGrid('exportdata', 'xls', 'รายงาน_OR_ผ่าตัดแยกแผนกรายปี');           
            });
