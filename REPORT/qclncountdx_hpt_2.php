...
WHERE
DATE_FORMAT(ovst.vstdttm,'%Y-%m-%d') BETWEEN '$year4' AND '$year4_1'
...
,'Z480','Z133','Z00','Z242','U77') 
      AND ovst.an=0 AND ovst.cln = 'G0100'
group by ovstdx.icd10
order by c5opd  desc
limit 50)as a INNER JOIN icd101 on icd101.icd10 = a.icd10  ORDER BY c5opd  desc";
