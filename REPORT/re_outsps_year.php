...
<body>
    ...
    <!-- /.col-lg-12 -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h3>รายงาน  IPD Refer ทั้งหมด</h3> 
                            <h3> </h3>
                            <p> </p>
  ...
  <script src="plugins/re_outsps_year5.js"></script>
                  <script src="plugins/re_outsps_year2.js"></script>

  		 <script src="plugins/re_outsps_year.js"></script>

 <script src="plugins/re_outsps_year4.js"></script>

	 <script src="plugins/re_outsps_year3.js"></script>
</body>
