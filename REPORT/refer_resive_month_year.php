  ...
  <!--MENU  HEAD-->
      ...
      <?php include_once ('menu.php'); ?>     
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานรับRefer 20 ลำดับ ผู้ป่วยนอก</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
   ...
   <option value="<?php echo date('Y')-6; ?>"><?php echo (date('Y')-6)+543; ?></option>
     ...
     <select name="month_by" id="month_by" class="form-control input-sm" style="width:auto;">
<?php
...
$connect =connectToDB();                                     
 $q=" SELECT month_list.code_month, 
	month_list.month_name
FROM month_list 
order by month_list.code_month  asc "; 
 $qr=mysql_query($q);
 while($rs=mysql_fetch_array($qr)){
?>
          <option value="<?php echo iconv('TIS-620','UTF-8', $rs['code_month']); ?>"> 
                <?php echo iconv('TIS-620','UTF-8', $rs['month_name']); ?>
                </option>
        <?php } ?>
            ...
            <div class="row">
                ...
                <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานส่งRefer 20 ลำดับ ผู้ป่วยนอก</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
         ...
         <div>
                <input type="button" value="Export to Excel" id='excelExportten2' />
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                             <h4>รายงานส่งrefer-opd</h4> 
                            <h3> </h3>
                            <p> </p>
                              <div class="row show-grid">
                          <div id="showdivten2"></div> 
    ...
    <script src="../js/sb-admin-2.js"></script>
	 ...
	 <script src="plugins/referopd_10_month_year.js"></script>
 <script src="plugins/refersend_opd_10_month_year.js"></script>  
