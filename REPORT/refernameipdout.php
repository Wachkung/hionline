...
select ovstdx.icd10,icd101.icd10name,COUNT(ovstdx.icd10) as nub from hi.ovstdx 
INNER JOIN hi.ovst on ovst.vn = ovstdx.vn 
inner join hi.icd101 on ovstdx.icd10 = icd101.icd10
INNER JOIN hi.orfri on orfri.vn = ovst.vn
where ovstdx.cnt = 1 and  date(ovst.vstdttm) between '20111001' and '20110930' group by icd10 order by nub desc LIMIT 30
";
