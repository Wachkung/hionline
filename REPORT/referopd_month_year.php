  ...
  <!--MENU  HEAD-->
   ...
   <option value="<?php echo date('Y')-6; ?>"><?php echo (date('Y')-6)+543; ?></option>
        ...
        <div>
         ...
         <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงาน ส่ง REFER- OPD  ตามปีงบประมาณ</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                <div>
                <input type="button" value="Export to Excel" id='excelExportsend' />
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                           <h4>ส่ง REFER opd แยกตามอำเภอรายเดือนตามปีงบประมาณ</h4> 
                            <h3> </h3>
                            <p> </p>
                              <div class="row show-grid">
                          <div id="showdivsend1"></div> 
               ...
               <div>
                <input type="button" value="Export to Excel" id='excelExportsend1' />
    ...
    <script src="plugins/referopd_month_year.js"></script>
 <script src="plugins/referopd_month_year1.js"></script>
 
  
 
  <script src="plugins/sendreferopd.js"></script>
 
  <script src="plugins/sendreferopd2.js"></script>
</body>
