...
<?php
 ...
 while ($row2 = mysql_fetch_array($resultpt10, MYSQL_ASSOC)) {
		$data2[] = array(
			      ...
			      'ward' => $row2['ward'],
			      'nameward' => iconv('TIS-620','UTF-8//IGNORE',$row2['nameward']) ,
			//    'FNAME' => 
		 	    'cvnward'=>  iconv('TIS-620','UTF-8//IGNORE',$row2['cvnward']) 
		  );
	}
