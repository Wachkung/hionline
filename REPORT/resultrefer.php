...
$query="
select a.rfrcs,a.namerfrcs,
       
SUM(CASE WHEN a.dchdate between '2010-10-01'and '2011-09-30' THEN a.can END) AS 'aaa' ,
SUM(CASE WHEN a.dchdate between '2011-10-01'and '2012-09-30' THEN a.can END) AS 'bbb' ,
 SUM(CASE WHEN a.dchdate between '2012-10-01'and '2013-09-30' THEN a.can END) AS 'ccc' ,
SUM(CASE WHEN a.dchdate between '2013-10-01'and '2014-09-30' THEN a.can END) AS 'ddd' 
...
WHERE year(ipt.dchdate) between'2010' and '2014'  
     and ipt.dchtype ='4'
GROUP BY ipt.an  ) as a  GROUP BY   rfrcs   ORDER BY  can DESC
";
		...
		$data[] = array(
			    ...
			    'FNAME' => 
		 	    'c5opd'=>  iconv('TIS-620','UTF-8//IGNORE',$row['c5opd']) */
		            ...
		            'rfrcs'=> $row['rfrcs'],
		        //  'namecln'=> $row['namecln'],
				 'namerfrcs'=>  iconv('TIS-620','UTF-8//IGNORE',$row['namerfrcs']),
				  'aaa'=> $row['aaa'] ,
				    'bbb'=> $row['bbb'] ,
