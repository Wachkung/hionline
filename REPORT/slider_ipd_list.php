...
<head>
    ...
    <meta charset="utf-8">
  <META HTTP-EQUIV="Refresh" CONTENT="05;URL=http://192.168.8.3/webhi/moniter/opd/slider_or_list.php">    
...
<body>
  ...
  <!-- Navigation -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default" >
                             <div  style=" width:100%; border:#f00 0px solid; float: left; font-size:30px; background-color:#076E00; color:#FFFFFF; "><center>จำนวนผู้มารับบริการงานผู้ป่วยใน</center></div>   
   ...
   <script src="plugins/ipd_list.js"></script>
   <script src="plugins/ipd_list2.js"></script>
