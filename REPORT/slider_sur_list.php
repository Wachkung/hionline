...
.bigfont2 {font-size: 50px; font-weight: bold; font-family: 'THSarabunNew';}
...
.left-data {width: 100%; border:#f00 0px solid; float: left; font-family: 'THSarabunNew'; margin-top: -10px;}
...
<body>
  ...
  <!-- Navigation -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default" >
                       <div  style=" width:100%; border:#f00 0px solid; float: left; font-size:35px; background-color:#58ACFA; color:#FFFFFF; "><center>รายชื่อผู้ป่วยตึกศัลยกรรมทั่วไป</center></div> 
   ...
   <script src="plugins/sur_list.js"></script>
