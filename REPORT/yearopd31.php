...
as hn
FROM ovst  where  date(ovst.vstdttm) BETWEEN '2013-10-01' and  '2014-09-30'  and ovst.cln <> '40100'   
	UNION
select    max(year(ovst.vstdttm)
+543)as yearvst,
     count(ovst.vn) as vn ,
     count(DISTINCT(ovst.hn))
as hn
FROM ovst  where  date(ovst.vstdttm) BETWEEN '2012-10-01' and  '2013-09-30'  and ovst.cln <> '40100'  
 UNION
select    max(year(ovst.vstdttm)
+543)as yearvst,
     count(ovst.vn) as vn ,
     count(DISTINCT(ovst.hn))
as hn
FROM ovst  where  date(ovst.vstdttm) BETWEEN '2011-10-01' and  '2012-09-30'  and ovst.cln <> '40100' 
";
